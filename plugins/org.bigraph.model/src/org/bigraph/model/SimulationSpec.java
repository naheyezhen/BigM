...
public class SimulationSpec extends ModelObject
	 ...
	 */
	@BigmProperty(fired = ReactionRule.class, retrieved = List.class)
	public static final String PROPERTY_RULE = "SimulationSpecRule";
	
	/**
	 * The property name fired when the model changes.
	 */
	@BigmProperty(fired = Bigraph.class, retrieved = Bigraph.class)
	...
	public static final String CONTENT_TYPE = "dk.itu.bigm.simulation_spec";
