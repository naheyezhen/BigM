...
public class PortSpec extends NamedModelObject implements IPort {
	@BigmProperty(fired = Control.class, retrieved = Control.class)
	public static final String PROPERTY_CONTROL = "PortSpecControl";
	
	@BigmProperty(fired = String.class, retrieved = String.class)
	public static final String PROPERTY_PORT_SORT = "PortSpecSort";
	...
	public final class ChangeRemovePort extends PortSpecChange {
		...
		private String oldPortSort;
		
		@Override
		public void beforeApply() {
			oldName = getCreator().getName();
			oldControl = getCreator().getControl();
			oldPortSort = getCreator().getPortSort();
		}
		
		@Override
		public boolean canInvert() {
			return (oldName != null && oldControl != null && oldPortSort != null);
		}
		
		@Override
		public Change inverse() {
			return oldControl.new ChangeAddPort(getCreator(), oldName, oldPortSort);
		}
		...
		public void simulate(PropertyScratchpad context) {
			...
			context.setProperty(getCreator(), PortSpec.PROPERTY_PORT_SORT, null);
	...
	public String getPortSort(PropertyScratchpad context) {
		return getProperty(context, PROPERTY_PORT_SORT, String.class);
	}
	
	protected void setPortSort(String portSort) {
		String oldPortSort = this.portSort;
		this.portSort = portSort;
		firePropertyChange(PROPERTY_PORT_SORT, oldPortSort, portSort);
	}
	...
	protected PortSpec clone(Control c) {
		...
		p.setControl(getControl());
		p.setPortSort(getPortSort());
		return p;
	}
