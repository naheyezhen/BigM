...
import static org.bigraph.model.loaders.BigmNamespaceConstants.EDIT;
...
public final class BigraphEditSaver implements Participant {
	...
	public static Element makeID(Document d, Identifier id) {
		...
		} else if (id instanceof Bigraph.Identifier) {
			el = d.createElementNS(EDIT_BIG, "edit-big:bigraph-id");
		} else {
			el = d.createElementNS(EDIT_BIG, "edit-big:unknown");
		}
