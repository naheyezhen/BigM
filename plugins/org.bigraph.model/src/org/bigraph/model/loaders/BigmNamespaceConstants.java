 ...
 * @author alec
 */
public abstract class BigmNamespaceConstants {
	private BigmNamespaceConstants() {}
	...
	/**
	 * The XML namespace for {@code <sortset>} documents.
	 */
	public static final
	String SORTSET = "http://www.itu.dk/research/pls/xmlns/2013/sortset";

	/**
	 * The XML namespace for {@code <sortsformrules>} documents.
	 */
	public static final
	String FORMATIONRULES = "http://www.itu.dk/research/pls/xmlns/2013/formationrules";
	
	/**
	 * The XML namespace for {@code <sortsformrules>} documents.
	 */
	public static final
	String SORTING = "http://www.itu.dk/research/pls/xmlns/2013/sorting";
	...
	/**
	 * The XML namespace for {@code <linkTypeConfig>} documents.
	 */
	public static final
	String LINKTYPE = "http://www.itu.dk/research/pls/xmlns/2013/linktype";
