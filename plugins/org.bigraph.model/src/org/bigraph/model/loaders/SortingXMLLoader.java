...
import static org.bigraph.model.loaders.BigmNamespaceConstants.RULE;
...
public class SortingXMLLoader extends XMLLoader {
	public SortingXMLLoader() {
	}
	
	public SortingXMLLoader(Loader parent) {
		super(parent);
	}
