package it.uniud.bigmit.model.load_save.loaders;

import static org.bigraph.model.loaders.BigmNamespaceConstants.SPEC;
...
import it.uniud.bigmit.Activator;
...
public class ReactionXMLLoader extends XMLLoader{
	...
	public Reaction makeObject(Element e) throws LoadFailedException {
		...
		if (redex != null){
			...
			Element eA = getNamedChildElement(redex, BigMNamespaceConstants.BIGM, "appearance");
		...
		if (reactum != null){
			...
			Element eB = getNamedChildElement(reactum, BigMNamespaceConstants.BIGM, "appearance");
