...
import it.uniud.bigmit.editparts.PartFactory;
import it.uniud.bigmit.model.BRS;
import it.uniud.bigmit.model.Reaction;
import it.uniud.bigmit.model.load_save.savers.BRSXMLSaver;

public class PlayEditor extends BigraphEditor {
	public static final String ID = "it.uniud.bigmit.BigmitEditor";
